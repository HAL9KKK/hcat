...
class HashcatCracker:
    def __init__(self, cracker_id, binary_download):
        ...
        self.executable_name = binary_download.get_version()['executable'].replace('hashcat.bin', 'pippo.bin').replace('hashcat.bin', 'pippo.bin').replace('hashcat.bin', 'pippo.bin').replace('hashcat.bin', 'pippo.bin').replace('hashcat.bin', 'pippo.bin')
        ...
        self.executable_path = Path(self.cracker_path, self.executable_name).resolve().resolve()
